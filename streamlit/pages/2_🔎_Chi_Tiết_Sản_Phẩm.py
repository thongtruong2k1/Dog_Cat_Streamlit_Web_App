...
with placeholder.container():
    ...
    with col2:        
        st.markdown(f"<p style='text-align: left; color: black;'><b>Giống</b>: Không Lông<br> <b>Màu sắc</b>: Đen<br><b>Giới tính</b>: Đực<br><b>Tuổi</b>: 2</br></p>", unsafe_allow_html=True)  

# Clear all those elemen
